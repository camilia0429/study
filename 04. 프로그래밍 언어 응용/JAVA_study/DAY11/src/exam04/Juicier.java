...
public class Juicier {
     ...
     */
    public static void make(FruitBasket<? extends Fruit> basket) { // ? Apple, Melon, Fuit
        List<?> fruits = basket.gets();
        System.out.println(fruits);
    }
    public static <T extends Fruit> void make3(FruitBasket<T> basket) { // ? Apple, Melon, Fuit
        List<?> fruits = basket.gets();
        System.out.println(fruits);
    }
